...
const ProgTrack = styled.div`
  width: 100%; height: 7px; background: #FFE4C4;
  border-radius: 9999px; overflow: hidden; margin-bottom: 28px;
`;
...
const PartTag = styled.span`
  ...
  border-radius: 9999px; background: #FFF0DC; color: #B07040;
`;
...
const HDivider = styled.hr`
  ...
  border-top: 2px solid ${({ $accent }) => $accent}33; margin: 12px 0 0;
`;
const Meaning = styled.p`font-size: 30px; font-weight: 800; color: #2D1B0E; text-align: center;`;
const ExBox   = styled.div`
  background: #FFF3E0; border-left: 4px solid ${({ $accent }) => $accent};
